...
public class NVMEController {
    ...
    public ResponseEntity<List<NVMEDTO>> createNVMEs(@RequestBody final List<NVMEDTO> nvmeDTOs) {
    ...
    public ResponseEntity<NVMEDTO> getNVME(@PathVariable String id) {
    ...
    public ResponseEntity<NVMEDTO> fullUpdateNVME(@PathVariable String id, @RequestBody NVMEDTO nvmeDTO) {
    ...
    public ResponseEntity<NVMEDTO> partialUpdate(@PathVariable String id, @RequestBody NVMEDTO nvmeDTO) {
    ...
    public ResponseEntity<NVMEDTO> deleteNVME(@PathVariable String id) {
