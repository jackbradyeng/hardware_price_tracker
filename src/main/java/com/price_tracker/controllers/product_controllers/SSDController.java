...
public class SSDController {
    ...
    public ResponseEntity<List<SSDDTO>> createSSDs(@RequestBody final List<SSDDTO> ssdDTOs) {
    ...
    public ResponseEntity<SSDDTO> getSSD(@PathVariable String id) {
    ...
    public ResponseEntity<SSDDTO> fullUpdateSSD(@PathVariable String id, @RequestBody SSDDTO ssdDTO) {
    ...
    public ResponseEntity<SSDDTO> partialUpdate(@PathVariable String id, @RequestBody SSDDTO ssdDTO) {
    ...
    public ResponseEntity<SSDDTO> deleteSSD(@PathVariable String id) {
