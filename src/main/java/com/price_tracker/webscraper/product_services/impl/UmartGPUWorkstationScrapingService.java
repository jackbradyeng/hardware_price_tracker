...
@Log
@Service
public class UmartGPUWorkstationScrapingService extends GenericUmartScraper {

    @Autowired
    public UmartGPUWorkstationScrapingService(PricePointObserver pricePointObserver) {
