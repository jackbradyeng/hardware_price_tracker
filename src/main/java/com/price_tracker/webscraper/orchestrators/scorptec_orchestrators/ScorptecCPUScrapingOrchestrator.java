...
import static com.price_tracker.constants.other_constants.ScrapingConstants.SCORPTEC_CPU_SCRAPING_TIME;
...
@Log
@Service
public class ScorptecCPUScrapingOrchestrator implements GenericProductScrapingOrchestrator {
    ...
    @Autowired
    public ScorptecCPUScrapingOrchestrator(CPUPricePointJDBCTemplate cpuPricePointJDBCTemplate,
