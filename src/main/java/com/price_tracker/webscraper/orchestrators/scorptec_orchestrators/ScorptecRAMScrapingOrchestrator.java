...
@Log
@Service
public class ScorptecRAMScrapingOrchestrator implements GenericProductScrapingOrchestrator {
    ...
    @Autowired
    public ScorptecRAMScrapingOrchestrator(RAMPricePointJDBCTemplate ramPricePointJDBCTemplate,
