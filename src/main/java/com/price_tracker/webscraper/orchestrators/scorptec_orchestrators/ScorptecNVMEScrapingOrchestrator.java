...
import static com.price_tracker.constants.other_constants.ScrapingConstants.SCORPTEC_NVME_SCRAPING_TIME;
...
@Log
@Service
public class ScorptecNVMEScrapingOrchestrator implements GenericProductScrapingOrchestrator {
    ...
    @Autowired
    public ScorptecNVMEScrapingOrchestrator(NVMEPricePointJDBCTemplate nvmePricePointJDBCTemplate,
