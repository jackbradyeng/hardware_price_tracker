...
import static com.price_tracker.constants.other_constants.ScrapingConstants.UMART_RAM_SCRAPING_TIME;
...
public class UmartRAMScrapingOrchestrator implements GenericProductScrapingOrchestrator {
    ...
    @Autowired
    public UmartRAMScrapingOrchestrator(RAMPricePointJDBCTemplate ramPricePointJDBCTemplate,
