...
import com.priceTracker.domain.entities.vendorEntities.ScorptecProductEntity;
...
@Repository
public interface ScorptecProductRepository extends JpaRepository<ScorptecProductEntity, String> {

    @Query("select u.url from ScorptecProductEntity u " +
